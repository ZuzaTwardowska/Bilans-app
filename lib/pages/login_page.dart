...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final loginButton = FormFieldComponents.formSubmitButton(context, "Login",
        [emailController, passwordController].toList(), login);
  ...
  void login(List<TextEditingController> controllers) async {
